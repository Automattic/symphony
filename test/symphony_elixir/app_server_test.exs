defmodule SymphonyElixir.AppServerTest do
  ...
  test "app server clears command tracking for malformed command completion frames" do
    ...
    try do
      ...
      assert_received {:app_server_message, recovered_message}
      assert recovered_message.event == :command_completed_recovered
      assert recovered_message.recovery == :malformed_command_completion
