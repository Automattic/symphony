...
Code.require_file("support/test_socket_base.exs", __DIR__)
...
mcp_socket_base_path = SymphonyElixir.TestSocketBase.prepare!(mcp_socket_base)
...
ExUnit.after_suite(fn _results ->
  ...
  File.rm_rf(mcp_socket_base_path)
end)
